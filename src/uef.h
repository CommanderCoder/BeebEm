...
/* setup */
extern void uef_setclock(int beats);
extern void uef_setunlock(bool unlock);

/* poll mode */
extern int uef_getdata(int time);

/* open & close */
extern bool uef_open(const char *name);
extern void uef_close(void);

/* writing */
extern bool uef_create(const char *name);
extern bool uef_putdata(int data, int time);
