...
static void SASITestUnitReady(void)
{
...
static void SASIRequestSense(void)
{
...
static void SASISetGeometory(void)
{
...
static void SASIRamDiagnostics(void)
{
	sasi.status = 0x00;
	sasi.message = 0x00;
	SASIStatus();
...
static void SASIControllerDiagnostics(void)
{
	sasi.status = 0x00;
	sasi.message = 0x00;
	SASIStatus();
