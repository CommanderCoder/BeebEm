...
// Keyboard mappings
static bKeyMap defaultMapping;
static bKeyMap logicalMapping;
...
BeebWin::BeebWin()
{
	...
	memset(&defaultMapping, 0, sizeof(bKeyMap));
	memset(&logicalMapping, 0, sizeof(bKeyMap));
	memset(&UserKeymap, 0, sizeof(bKeyMap));
